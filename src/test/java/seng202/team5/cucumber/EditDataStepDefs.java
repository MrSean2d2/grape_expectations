...
public class EditDataStepDefs {
    ...
    @Given("wine with details {string}, {string}, {int}, {int}, {int}, {string}, {string}, vineyard in database")
    public void wineInDatabase(String name, String description, Integer year, Integer rating, Integer price, String variety, String colour) throws NotFoundException {
    ...
    public void existingWineUpdated() throws NotFoundException {
        Assertions.assertEquals("very nice wine", wineDAO.getWineFromName("test e wine").getDescription());
    }
