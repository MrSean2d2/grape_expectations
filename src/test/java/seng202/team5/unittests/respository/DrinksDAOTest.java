...
public class DrinksDAOTest {
    ...
    public void testGetAllUser() throws DuplicateEntryException {
        ...
        Drinks testReview3 = new Drinks(testWine2.getId(), testUser.getId(), true, "Great wine3", 5);
        Drinks testReview4 = new Drinks(testWine2.getId(), testUser2.getId(), true, "Great wine4", 5);
        Drinks testReview5 = new Drinks(testWine3.getId(), testUser.getId(), true, "Great wine5", 5);
    ...
    public void testUpdate() throws DuplicateEntryException {
        ...
        assertEquals("Great wine", drinksDAO.getWineReview(testWine.getId(), testUser.getId()).getNotes());
